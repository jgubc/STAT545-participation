...
gapminder %>% 
  ...
  geom_line(alpha = 1/3)+ 
  scale_color_discrete("Legend", labels = c("other", "Rwanda"))
```
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
  ...
  facet_wrap(~ continent, scales = "free_x") # scales = free or free_x or free_y
...
gapminder %>% 
  ...
  ggplot(aes(gdpPercap, lifeExp, size = pop, fill = continent)) + # color = continent
...
gapminder %>% 
  ...
  ggridges::geom_density_ridges() + ## geom ridges to measure spread
  geom_rug()
