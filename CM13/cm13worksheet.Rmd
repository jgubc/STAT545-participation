...
1. Less clutter on graphs
2. Legends and additional information for context displayed appropriately 
3. Visuals convey information without lot of written text
4. Color combinations/scales are choosen with regards to analysis
...
3. Balances proportions
4. Themes are properly choosen
...
p <- gapminder %>% 
  plot_ly(x= ~gdpPercap,
          ...
          color = ~continent,
          type = 'scatter',
          mode = 'markers') #mode = 'line'

Sys.setenv('plotly_username' = '')
Sys.setenv('plotly_api_key' = '')
create_api(p, filename = '')
